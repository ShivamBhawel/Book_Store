...
router.put('/update-book', authenticateToken, async (req, res) => {
  try {
    const bookid = req.headers.bookid; // Make sure to send "bookid" in headers
    const data = req.body;

    await Book.findByIdAndUpdate(bookid, data); // No need to wrap "data" inside {data}
...
router.delete('/delete-book', authenticateToken, async (req, res) => {
  try {
    ...
    await Book.findByIdAndDelete(bookid); // No need to wrap "data" inside {data}
