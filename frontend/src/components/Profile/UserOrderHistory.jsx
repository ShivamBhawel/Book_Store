...
const UserOrderHistory = () => {
  ...
  useEffect(() => {
      ...
      const fetch = async () => {
        try{
          ...
          const res = await axios.get("http://localhost:2000/order/get-order-history",
             { headers});
  ...
  return (
<>
   <div className=' flex items-center justify-center'>{  !orderHistory && <Loader /> }</div>
      ...
      <div className='h-[100%] p-0 md:p-4 text-zinc-100'>
        ...
        <div className='mt-4 bg-zinc-800 w-full rounded py-2 px-4 flex gap-2'>
          <div className='w-[3%]'>
           ...
           <div className='w-non md:w-[5%] hidden md:block'>
                <h1>Mode</h1>
          </div>
        </div>
