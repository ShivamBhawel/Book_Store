  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center'> 
       ...
       <Link 
        ...
        <button className='bg-zinc-900 w-3/6 lg:w-full lg:mt-0 text-white font-semibold flex items-center justify-center py-2 rounded hover:bg-zinck-700 transition-all duration-300'>
